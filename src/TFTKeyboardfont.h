const uint8_t KeyboardfontBitmaps[] PROGMEM = {
...
const GFXglyph KeyboardfontGlyphs[] PROGMEM = {
  {     0,  12,   8,  13,    0,  -11 }   // ''
 ,{    12,  12,   8,  13,    0,  -11 }   // ''
 ,{    24,  13,  17,  14,    0,  -16 }   // ''
 ,{    53,  13,  17,  14,    0,  -16 }   // ''
...
const GFXfont TFTKeyboardfont PROGMEM = {
  (uint8_t  *)KeyboardfontBitmaps,
  (GFXglyph *)KeyboardfontGlyphs,
  0x18, 0x86, 29 };
